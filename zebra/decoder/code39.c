...
static inline signed char code39_decode9 (zebra_decoder_t *dcode)
{
...
static inline signed char code39_decode_start (zebra_decoder_t *dcode)
{
    code39_decoder_t *dcode39 = &dcode->code39;
...
static inline void code39_postprocess (zebra_decoder_t *dcode)
{
    code39_decoder_t *dcode39 = &dcode->code39;
    int i;
