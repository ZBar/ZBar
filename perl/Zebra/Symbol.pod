...
Zebra::Symbol - bar code scan result object
...
Zebra::Symbol objects are constant results returned for each bar code
scanned from images or video.  This object wraps the raw symbol data
with additional information about the decode (symbology, confidence,
location, etc)
...
Zebra, Zebra::Image, zebraimg(1), zebracam(1)
