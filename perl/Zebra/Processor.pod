...
Zebra::Processor - self-contained bar code reader
...
A Zebra::Processor may be used to quickly create stand-alone bar code
scanning applications.  It has interfaces to scan images or video and
to optionally display a video/image preview to a window.
...
interaction.  Use a Zebra::ImageScanner or Investigate the avilable
...
be invoked with the associated Zebra::Processor object and I<closure>
as arguments.  Closure may be achieved either using standard Perl
closure or by manually passing a scalar via I<closure>.
...
Scan a Zebra::Image for bar codes.
...
Zebra, Zebra::Image, Zebra::ImageScanner, zebraimg(1), zebracam(1)
