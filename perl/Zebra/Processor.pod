...
Barcode::Zebra::Processor - self-contained bar code reader
...
A Barcode::Zebra::Processor may be used to quickly create stand-alone
...
interaction.  Use a Barcode::Zebra::ImageScanner or Investigate the
...
be invoked with the associated Barcode::Zebra::Processor object and
...
Barcode::Zebra, Barcode::Zebra::Image, Barcode::Zebra::ImageScanner
