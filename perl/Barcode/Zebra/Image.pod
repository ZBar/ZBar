...
Barcode::Zebra::Image - image object to scan for bar codes
...
Barcode::Zebra::Image is used to pass images to the bar code scanner.
...
Create a new Barcode::Zebra::Image object.  The size, pixel format and
...
Return a list of scanned Barcode::Zebra::Symbol results attached to
this image.

=item convert(I<format>)

Return a new Barcode::Zebra::Image object converted to the indicated
...
Barcode::Zebra, Barcode::Zebra::Image, Barcode::Zebra::Symbol
